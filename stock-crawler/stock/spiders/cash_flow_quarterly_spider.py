...
class CashFlowQuarterlySpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for stock_code in stock_codes:
            url = 'http://jdata.yuanta.com.tw/z/zc/zc3/zc3_{stock_code}.djhtm' \
    ...
    def parse(self, response):
        ...
        XPATH_ROOT = '//*[@id="SysJustIFRAMEDIV"]/table/tr[2]/td[2]/table[1]/tr/td/table/tr[not(@id="oScrollFoot")]'
