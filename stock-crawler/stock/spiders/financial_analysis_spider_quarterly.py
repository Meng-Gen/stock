...
class FinancialAnalysisQuarterlySpider(scrapy.Spider):
    name = "FinancialAnalysisQuarterly"
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    def start_requests(self):
        ...
        for stock_code in stock_codes:
            url = 'http://jdata.yuanta.com.tw/z/zc/zcr/zcr_{stock_code}.djhtm' \
    ...
    def parse(self, response):
        ...
        XPATH_ROOT = '//*[@id="SysJustIFRAMEDIV"]/table/tr/td/table/tr/td/table/tr[not(@id="oScrollHead")]'
